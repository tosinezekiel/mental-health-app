...
const ReportPage = () => {
  return (
    <div className="report bg-gray-100">
      ...
      <ReportSection title="Potential Problems" content={reportData.PotentialProblem} />
      <ReportSection title="Positive Aspects" content={reportData.PositiveAspect} />
      <ReportSection title="Things to Work On" content={reportData.ThingsToWorkOn} />
      <ReportSection title="Recommendations" content={reportData.Recommendations} />
      <ReportSection title="Additional Comments" content={reportData.AdditionalComments} />
      <ReportSection title="Potential Disorder to Consider" content={reportData.PotentialDisorderToConsider} />
